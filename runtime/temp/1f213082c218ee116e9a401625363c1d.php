...
<form id ="mForm" method="post" action="/SafetyMng/CheckTask/StartCheck/CheckListID/<?php echo $CheckInfoRow['id']; ?>">
    <div class="col-xs-12" style="padding: 0px;margin: 0px;">
        <?php if($Warning == ''): ?><div class="alert alert-info" role="alert"><strong>提示：</strong>在线检查页面。</div><?php endif; if($Warning != ''): ?><div class="alert alert-danger" role="alert"><strong>提示：</strong><?php echo $Warning; ?></div><?php endif; ?>
    </div>
    <h3 style="text-align: center;color: #1c1c1c;"><?php echo $CheckInfoRow['CheckName']; ?></h3>
    <hr/>
    <div class="row" gyRow>
        <div class="col-xs-offset-1 col-xs-3" DYL><span LBSpan>检查编号:</span></div>
        <div class="col-xs-7" DEL>
            <span CTSpan><?php echo $CheckInfoRow['CheckCode']; ?></span>
        </div>
    </div>
    <div class="row" gyRow>
        <div class="col-xs-offset-1 col-xs-3" DYL><span LBSpan>任务来源:</span></div>
        <div class="col-xs-8" DEL>
            <span CTSpan><?php echo $CheckInfoRow['CheckSource']; ?></span>
        </div>
    </div>
    <div class="row" gyRow>
        <div class="col-xs-offset-1 col-xs-3" DYL><span LBSpan>检查人员:</span></div>
        <div class="col-xs-8" DEL>
