...
--
-- Host: 127.0.0.1
-- Generation Time: 2019-04-02 14:58:04
-- 服务器版本： 5.7.21
-- PHP Version: 7.1.16
...
INSERT INTO `CheckList` (`id`, `CheckCode`, `CheckName`, `CheckSource`, `Checkers`, `ScheduleDate`, `DutyCorp`, `TaskID`, `AddTime`, `Status`) VALUES
(66, 'HKQNJ-JX-20190402085732', '19年3月21日日常检查', '航空器年检', '王金燕   王继红  ', '2019-04-02', '机务三队', 267, '2019-04-02 08:57:32', '检查单未制定'),
(67, 'FDZC-JX-20190402092302', '19年3月法定自查第一小组', '维修单位法定自查', '李光耀   史相陆  ', '2019-04-02', '机务二队', 268, '2019-04-02 09:23:02', '检查已开始');
...
--
-- 转存表中的数据 `CheckListDetail`
--

INSERT INTO `CheckListDetail` (`id`, `CheckDBID`, `CheckListID`, `FirstHalfTBID`, `CheckStandSnap`, `SecondHalfTBID`, `ComplianceStandard`, `AddTime`, `NonConfirmDutyCorp`, `IsOk`, `NonConfirmDesc`, `Checker`, `CheckTime`, `DealType`, `RelatedTaskID`, `RelatedID`) VALUES
(81, 1, 62, 3, '1、质量经理负责本手册及工作程序手册的修订，并负责报适航部门审批。\n2、批准后的《维修管理手册》及《维修管理程序手册》由技术科负责编号、发放和管理。\n\n\n\n\n\n\n\n\n', 2, '机库和车间照维修工作有效进行。2', '2019-04-01 21:26:17', NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL),
(82, 1, 62, 4, '1、机库和车间应当具有满足维修工作要求的水、电和气源。\r\n2、照明应当能保证每项检查及维修工作有效进行。', 3, '机库和车间照维修工作有效进行。为而为热舞3', '2019-04-01 21:26:17', NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL),
(83, 1, 62, 6, '标准4', 5, '和气源。\n2、照明应当能5', '2019-04-01 21:26:17', NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL),
(84, 1, 63, 2, '标准1', 1, '可以预防风雪1', '2019-04-01 21:50:20', NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL),
(87, 1, 64, 2, '标准1', 1, '可以预防风雪1', '2019-04-01 22:59:29', NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL),
(88, 1, 64, 4, '1、机库和车间应当具有满足维修工作要求的水、电和气源。\r\n2、照明应当能保证每项检查及维修工作有效进行。', 3, '机库和车间照维修工作有效进行。为而为热舞3', '2019-04-01 22:59:29', NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL),
(89, 1, 64, 6, '标准4', 5, '和气源。\n2、照明应当能5', '2019-04-01 22:59:29', NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL),
(90, 1, 65, 3, '1、质量经理负责本手册及工作程序手册的修订，并负责报适航部门审批。\n2、批准后的《维修管理手册》及《维修管理程序手册》由技术科负责编号、发放和管理。\n\n\n\n\n\n\n\n\n', 2, '机库和车间照维修工作有效进行。2', '2019-04-02 08:19:07', NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL),
(91, 1, 65, 4, '1、机库和车间应当具有满足维修工作要求的水、电和气源。\r\n2、照明应当能保证每项检查及维修工作有效进行。', 3, '机库和车间照维修工作有效进行。为而为热舞3', '2019-04-02 08:19:07', NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL),
(92, 1, 65, 2, '标准1', 1, '可以预防风雪1', '2019-04-02 08:25:25', NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL),
(93, 1, 67, 2, '标准1', 1, '可以预防风雪1', '2019-04-02 14:48:43', NULL, 'NO', '&lt;p&gt;&lt;video class=&quot;edui-upload-video  vjs-default-skin video-js&quot; controls=&quot;&quot; preload=&quot;none&quot; width=&quot;420&quot; height=&quot;280&quot; src=&quot;/upload/20190402/606518449d09637ae3945187e377bab0.mp4&quot; data-setup=&quot;{}&quot;&gt;&lt;source src=&quot;/upload/20190402/606518449d09637ae3945187e377bab0.mp4&quot; type=&quot;video/mp4&quot;/&gt;&lt;/video&gt;&lt;/p&gt;', '史相陆  ', '2019-04-02 22:41:37', '问题提交', 286, 158),
(94, 1, 67, 3, '1、质量经理负责本手册及工作程序手册的修订，并负责报适航部门审批。\n2、批准后的《维修管理手册》及《维修管理程序手册》由技术科负责编号、发放和管理。\n\n\n\n\n\n\n\n\n', 2, '机库和车间照维修工作有效进行。2', '2019-04-02 14:48:43', '机务二队', 'NO', '&lt;p&gt;考虑考虑&lt;/p&gt;', '史相陆  ', '2019-04-02 22:53:29', '问题提交', 291, 163),
(95, 1, 67, 4, '1、机库和车间应当具有满足维修工作要求的水、电和气源。\r\n2、照明应当能保证每项检查及维修工作有效进行。', 3, '机库和车间照维修工作有效进行。为而为热舞3', '2019-04-02 14:48:43', '机务二队', 'NO', '&lt;p&gt;经历了斤斤计较&lt;/p&gt;', '史相陆  ', '2019-04-02 22:55:16', '立即整改', NULL, 57);
...
INSERT INTO `FirstHalfCheckTB` (`id`, `BaseDBID`, `ProfessionName`, `BusinessName`, `CheckSubject`, `Code1`, `Code2`, `CheckContent`, `CheckStandard`, `AdderName`, `AddTime`, `OldID`, `IsValid`) VALUES
(2, 1, '航务', '气象', '30002.1\r\n机库或车间', 'FSOP.145', '30002.1 机库或车间', '30002\r\n厂房设施', '标准1', '李光耀', '2019-03-27 00:00:00', 0, 'YES'),
(3, 1, '适航维修', '飞机维修', '30001\r\n维修单位手册', 'FSOP.145', '30001.1', '《维修管理手册》的形式', '1、质量经理负责本手册及工作程序手册的修订，并负责报适航部门审批。\n2、批准后的《维修管理手册》及《维修管理程序手册》由技术科负责编号、发放和管理。\n\n\n\n\n\n\n\n\n', '李光耀', '2019-03-14 00:00:00', 0, 'YES'),
(4, 1, '航务', '气象', '30002.1\r\n机库或车间', 'FSOP.145', '30002.4', '机库或车间水、电、气和灯光', '1、机库和车间应当具有满足维修工作要求的水、电和气源。\r\n2、照明应当能保证每项检查及维修工作有效进行。', '史相陆  ', '2019-03-19 09:16:34', 0, 'YES'),
(6, 1, '航务', '气象', '30002.1\r\n机库或车间', 'FSOP.145', '30002.1 机库或车间', '30002\r\n厂房设施', '标准4', '史相陆  ', '2019-03-19 16:28:55', 0, 'YES');
...
--
-- 转存表中的数据 `SecondHalfCheckTB`
--

INSERT INTO `SecondHalfCheckTB` (`id`, `OldID`, `CheckStandardID`, `ComplianceStandard`, `CheckMethods`, `BasisName`, `BasisTerm`, `RelatedCorps`, `CheckFrequency`, `AdderName`, `AddTime`, `IsValid`) VALUES
(1, 0, 2, '可以预防风雪1', '', 'CCAR-145.20', 'CCAR-145.20', '机务二队机务三队机务四队机务一队', '1次/年', '史相陆  ', '2019-03-19 19:52:17', 'YES'),
(2, 0, 3, '机库和车间照维修工作有效进行。2', '远程文件审查|现场实地审查', 'CCAR-145.20', 'CCAR-145.20', '机务二队机务三队机务四队机务一队', '1次/年', '史相陆  ', '2019-03-19 20:02:04', 'YES'),
(3, 0, 4, '机库和车间照维修工作有效进行。为而为热舞3', '', 'CCAR-145.20', 'CCAR-145.20', '部领导航材科机务二队机务三队', '1次/年', '史相陆  ', '2019-03-19 20:03:54', 'YES'),
(5, 0, 6, '和气源。\n2、照明应当能5', '', 'CCAR-145.20', 'CCAR-145.20', '航材科|机务三队|机务一队', '1次/年', '史相陆  ', '2019-03-19 20:08:16', 'YES');
...
(268, 0, '在线检查任务', '19年3月法定自查第一小组', '2019-04-02 09:23:02', NULL, NULL, NULL, NULL, '质检科', '李光耀   史相陆   ', '20190402092302553', NULL, '', 67, '否', NULL, NULL),
(269, 0, '问题-立即整改', '雷兔兔', '2019-04-02 15:52:52', NULL, NULL, NULL, NULL, '质检科', NULL, NULL, NULL, '', 144, '否', NULL, NULL),
(270, 0, '问题-立即整改', '突突突', '2019-04-02 15:53:49', NULL, NULL, NULL, NULL, '质检科', NULL, NULL, NULL, '', 145, '否', NULL, NULL),
(271, 270, '整改通知书', '突突突', '2019-04-02 15:53:49', '2019-04-02', '史相陆  ', '史相陆  ', '质检科', '机务二队', NULL, NULL, '未分析原因制定措施', '', 54, '否', NULL, NULL),
(272, 0, '问题-立即整改', '图提高', '2019-04-02 16:24:24', NULL, NULL, NULL, NULL, '质检科', NULL, NULL, NULL, '', 146, '否', NULL, NULL),
(273, 272, '整改通知书', '图提高', '2019-04-02 16:24:24', '2019-04-02', '史相陆  ', '史相陆  ', '质检科', '机务二队', NULL, NULL, '未分析原因制定措施', '', 55, '否', NULL, NULL),
(274, 0, '问题-立即整改', '季姬击鸡记', '2019-04-02 16:38:27', NULL, NULL, NULL, NULL, '质检科', NULL, NULL, NULL, '', 147, '否', NULL, NULL),
(275, 274, '整改通知书', '季姬击鸡记', '2019-04-02 16:38:27', '2019-04-02', '史相陆  ', '史相陆  ', '质检科', '机务二队', NULL, NULL, '未分析原因制定措施', '', 56, '否', NULL, NULL),
(276, 0, '问题-待处理', '问题1', '2019-04-02 19:32:24', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 148, '否', NULL, NULL),
(277, 0, '问题-待处理', '短发短发的撒大法师 ', '2019-04-02 19:35:49', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 149, '否', NULL, NULL),
(278, 0, '问题-待处理', '呕吐机会', '2019-04-02 19:52:57', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 150, '否', NULL, NULL),
(279, 0, '问题-待处理', '啦啦啦吧', '2019-04-02 20:06:43', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 151, '否', NULL, NULL),
(280, 0, '问题-待处理', '艾克里里了', '2019-04-02 20:09:35', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 152, '否', NULL, NULL),
(281, 0, '问题-待处理', '艾克里里了', '2019-04-02 20:10:22', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 153, '否', NULL, NULL),
(282, 0, '问题-待处理', '模棱两可', '2019-04-02 20:11:04', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 154, '否', NULL, NULL),
(283, 0, '问题-待处理', '考虑考虑', '2019-04-02 20:13:15', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 155, '否', NULL, NULL),
(284, 0, '问题-待处理', '乌克丽丽', '2019-04-02 22:36:54', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 156, '否', NULL, NULL),
(285, 0, '问题-待处理', '乌克丽丽', '2019-04-02 22:37:29', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 157, '否', NULL, NULL),
(286, 0, '问题-待处理', '我先洗洗澡', '2019-04-02 22:41:37', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 158, '否', NULL, NULL),
(287, 0, '问题-待处理', '季姬击鸡记', '2019-04-02 22:50:04', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 159, '否', NULL, NULL),
(288, 0, '问题-待处理', '季姬击鸡记', '2019-04-02 22:52:46', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 160, '否', NULL, NULL),
(289, 0, '问题-待处理', '季姬击鸡记', '2019-04-02 22:53:07', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 161, '否', NULL, NULL),
(290, 0, '问题-待处理', '季姬击鸡记', '2019-04-02 22:53:09', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 162, '否', NULL, NULL),
(291, 0, '问题-待处理', '季姬击鸡记', '2019-04-02 22:53:29', NULL, '史相陆  ', '史相陆  ', '质检科', '质检科', NULL, NULL, NULL, '', 163, '否', NULL, NULL),
(292, 0, '问题-立即整改', '考虑考虑', '2019-04-02 22:55:16', NULL, NULL, NULL, NULL, '质检科', NULL, NULL, NULL, '', 164, '否', NULL, NULL),
