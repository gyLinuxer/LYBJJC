...
*/
$encodingAesKey = "gww6bdAUmUSUlkds1HGrJCApW40Gq5IWu7L0Ov4TZy5";
$token = "zkgy2000";
$corpId ="wxd364401c517fb9cf"; //这里已正确填写自己的corpid
//公众号服务器数据
$sReqMsgSig = $sVerifyMsgSig = empty($_GET['msg_signature'])?$_GET['signature']:$_GET['msg_signature'];
...
file_put_contents("log",var_dump($_GET));
