...
class UEditorGYHelp extends Controller{

    private $uploadfolder='/upload/';   //上传地址

    private $scrawlfolder='/upload/';   //涂鸦保存地址

    private $catchfolder='/upload/';   //远程抓取地址

    private $configpath='static/UEditor/php/config.json';
    ...
    public function index(){
        ...
        switch ($action) {
            ...
            default:
                $result = json_encode(array('state'=> 'Err'));
                break;
        }
