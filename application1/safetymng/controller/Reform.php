...
class Reform extends PublicController{
    ...
    public function showFastReformIndex($TaskID=0,$ReformID=0)
    {
    ...
    public function SaveReformData($FunName = '',$TaskID=0,$ReformID=0,$opType='New'){
        ...
        switch ($FunName){
            ...
            case 'showFastReformIndex':{
                return $this->showFastReformIndex($TaskID,$ReformID);
            }
        }
        return '';
    }
    ...
    public function GetReformStatusColor($ReformStatus){
            $Color = array(1=>'default',2=>'default',3=>'warning',4=>'danger',5=>'warning',6=>'warning',7=>'success',8=>'danger');
